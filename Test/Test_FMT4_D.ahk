...
*******************************************************************************
*/
FilePathficheroExcelLectura := "C:\Users\egarciar\Documents\CAIXA\AutoHotKeyEGR\Datos_Prueba\Excel_Filas_Logicas.xlsx"
...
numero_Elementos_Array_TipoOrden := Array_TipoOrden.length() 
   controlWhile1 := 1 ;Cogemos la columna uno solo para las pruebas de ordenacion repetidas Logica
   While, controlWhile1 <= numero_ColumnasFichero {
      Resultado := ""
      FilePathficheroExcelSalida := "C:\Users\egarciar\Documents\CAIXA\AutoHotKeyEGR\Datos_Prueba\Resultados\Test_FMT4\Excel_Filas_Logicas_OrdenadasRepetidas"
